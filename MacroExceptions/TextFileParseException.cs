...
namespace MacroExceptions
{
    ...
    ///
    public class
    TextFileParseException : Exception
    {

        public TextFileParseException(string description, int lineNumber, string line)
            : this(description, null, lineNumber, line, null)
        {
        }


        public TextFileParseException(string description, string path, int lineNumber, string line)
            : this(description, path, lineNumber, line, null)
        {
        }


        public TextFileParseException(string description, int lineNumber, string line, Exception innerException)
