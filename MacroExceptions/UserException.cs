...
namespace MacroExceptions
{
    ...
    public class UserException : Exception
    {
        ...
        /// </exception>
        ///
        public UserException(string userFacingMessage)
            : this(
        ...
        /// </exception>
        ///
        public UserException(string userFacingMessage, Exception innerException)
            : this(
                Guard.NotNull(userFacingMessage, nameof(userFacingMessage)),
        ...
        /// </exception>
        ///
        public UserException(Exception userFacingInnerException)
            : this(
        ...
        /// </summary>
        ///
        public bool IsInnerExceptionUserFacing
        {
            get;
            private set;
        }
        ...
        /// </summary>
        ///
        public IEnumerable<Exception> UserFacingExceptionChain
        {
            get
            {
